  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Sort the data in descending order based on a property (e.g., timestamp)
        const sortedData = jsonData.sort((a, b) => {
          return new Date(b.timestamp) - new Date(a.timestamp); // Adjust 'timestamp' to the property you want to sort by
        });
